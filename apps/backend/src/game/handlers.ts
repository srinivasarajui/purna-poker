import type { Game, Story, Participant } from "@prisma/client";
import { nanoid } from 'nanoid'
import { emitGameChange } from "./util";
...
export async function processGameUpdate(gameCache: GameCache, gameId: string, action: (game: Game) => void) {
